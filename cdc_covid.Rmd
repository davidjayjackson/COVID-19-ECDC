...
CDC <- readxl::read_xlsx("../db/COVID-2020-03-19.xlsx")
# CDC <- readxl::read_xls("../db/COVID-2020-03-19.xlsx")
...
ggplot(USA_cases) + geom_line(aes(x=Reported,y=Per_Case)) +
  scale_y_continuous(labels=scales::percent) +
  labs(title="USA Reported Case as a Ratio of Total World")
```
...
ggplot(USA_deaths) + geom_line(aes(x=Reported,y=PercentDeaths)) +
  scale_y_continuous(labels=scales::percent) +
  labs(title="USA Reported Deaths as a Ratio of Total World")
```
