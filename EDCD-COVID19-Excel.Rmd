...
```
```{r}
PAK %>% ggplot() + geom_line(aes(x=Date,y=Cases)) +
  labs(title="PAK Daily Case Totals")
```
```{r}
PAK %>% ggplot() + geom_line(aes(x=Date,y=Deaths)) +
...
```
```{r}
PAK_weekly %>% ggplot() + geom_line(aes(x=Weekly,y=tc)) +
  labs(title="PAK Weekly Case Totals")
```
```{r}
PAK_weekly  %>% ggplot() + geom_line(aes(x=Weekly,y=td)) +
